...
local minimizeButton = Instance.new("TextButton") minimizeButton.Size = UDim2.new(0, 50, 0, 20) minimizeButton.Position = UDim2.new(0, 0, 0, -20) minimizeButton.BackgroundColor3 = Color3.fromRGB(0, 0, 139) minimizeButton.Text = "_" minimizeButton.TextColor3 = Color3.fromRGB(30, 30, 30) minimizeButton.Parent = frame

local autoFarmButton = Instance.new("TextButton") autoFarmButton.Size = UDim2.new(0, 280, 0, 50) autoFarmButton.Position = UDim2.new(0, 10, 0, 75) autoFarmButton.BackgroundColor3 = Color3.fromRGB(30, 30, 30) autoFarmButton.Text = "Auto Farm" autoFarmButton.TextColor3 = Color3.fromRGB(255, 255, 255) autoFarmButton.Parent = frame
