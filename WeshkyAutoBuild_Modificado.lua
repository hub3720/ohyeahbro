...
_G.baseColor = Color3.fromRGB(230, 120, 10)
...
local L_3_ = {
	...
	main_color = Color3.fromRGB(200, 44, 44),
	...
	function L_148_.new(L_156_arg0)
		...
		function L_157_:onInputChanged(L_158_arg0)
			if L_157_.held then
				...
				local L_161_ = L_157_.startPosition + UDim2.new(0, L_160_.X, 0, L_160_.Y)
...
function BetaInstantLoad()
	...
	local function L_417_func(L_447_arg0, L_448_arg1, L_449_arg2)
		L_2_:Notify(
			...
			OutlineColor = Color3.fromRGB(200, 44, 44),
			Time = 5,
			Type = "image"
		}, {
...
-- Function to process all parts
    ...
    -- Ensure all parts have been processed
		...
		if # L_432_ == L_442_ then
			L_432_ = {}
			L_417_func("Success", "Your build has been successfully loaded. You may now save.", Color3.fromRGB(255, 84, 84))
			L_444_func()
			L_442_ = 0
		end
	end
...
function BetaInstantLoad3()
	...
	local function L_519_func()
		task.defer(
			...
			if # L_507_ == L_517_ then
				L_507_ = {}
				L_492_func("Success", "Your build has been successfully loaded. You may now save.", Color3.fromRGB(255, 84, 84))
				task.wait(8)
				L_513_func(L_508_)
			end
		end)
	...
	local function L_520_func()
		if L_504_ and # L_504_:GetChildren() == 0 then
			L_492_func("ERROR", "You need a preview loaded before using this", Color3.fromRGB(255, 84, 84))
			L_491_ = true
			return
		end
		L_510_func()
    ...
    -- If not stopped, proceed with processing all parts
	if not L_491_ then
		L_492_func("Loading.......", "Build will start shortly", Color3.fromRGB(255, 84, 84))
		L_519_func()
	end
end
...
function LoadBlocks(L_652_arg0, L_653_arg1)
	...
	L_2_:Notify(
        {
		Title = "Success",
		Description = "You may now save your build once its fully finished"
	}, {
		OutlineColor = Color3.fromRGB(200, 44, 44),
		Time = 5,
		Type = "image"
...
do
	local L_759_ = L_93_:AddWindow("BoatBuilderHub", {
		main_Pos = UDim2.new(0, 100, 0, 100),
		min_size = Vector2.new(500, 550),
		can_resize = true,
		main_text_color = Color3.fromRGB(255, 255, 255)
	})
	local L_760_ = L_93_:AddWindow("Block Checker", {
	...
	local L_768_ = L_760_:AddTab("CheckPrice")
	...
	function ListBuild(L_774_arg0)
		...
		L_2_:Notify(
            {
			Title = "Wait Please",
			Description = "Big Files may take longer to load it is not broken just wait please :)"
		}, {
			OutlineColor = Color3.fromRGB(200, 44, 44),
			Time = 5,
			Type = "image"
	...
	do -- Elements
		...
		local L_824_ = L_762_:AddLabel("How to use: \n #1 Download a .build file from my discord \n #2 Place the .build file into workspace \n #3 Select the file, press preview, then load")
		local L_825_ = L_762_:AddLabel("")
		local L_826_ = L_762_:AddLabel("--- Builder Tab ---")
		local L_827_ = L_762_:AddFolder("New Builder")
		L_827_:Fold(true)
		...
		local L_845_ = L_844_:AddLabel("--- Saves ---")
		...
		local L_865_ = L_771_:AddFolder("May Not Work With Script") -- Red folder
		local L_866_ = L_771_:AddFolder("Beta/New") -- Red folder
		L_771_:AddLabel("This is in beta and is just stuff i had..")
		L_865_:AddLabel("Most of this will interfere with the rest of the script")
		L_866_:AddLabel("Most of this should be supported to use in the script")
		L_865_:AddButton("HighLight Player Blocks (May Break autobuild/game)", function()
		...
		L_772_:AddLabel("Thanks for Using Boat Builder Hub feel free to donate to me on my discord")
		L_772_:AddLabel("")
		L_772_:AddLabel("")
